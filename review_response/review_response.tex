...
\begin{abstract}
    ...
    These comments are very useful for us to improve our paper. 
    Below, we address every comment carefully and 
...
\textbf{Response} This is a good point of view.
In order to make the reason clear, we will need to do more experiments.
That can be our future work.
...
We have made this more clearly in Section~4.4 (Combining Cost Functions). 
