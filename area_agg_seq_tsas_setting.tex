...
%if a reference has doi, then only print doi in bibliography;
%otherwise, only print eprint; otherwise, print url
...
%[abbreviate=true, dateabbrev=true, isbn=true, doi=true, urldate=comp, url=true, maxbibnames=9, backref=false, backend=bibtex, style=ACM-Reference-Format, language=american,natbib]{biblatex}
